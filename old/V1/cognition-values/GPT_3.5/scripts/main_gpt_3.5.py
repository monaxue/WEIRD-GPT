...
from prompts import additional_values_questions as additional_values_questions

# Set the API key
openai.api_key = os.getenv("OPENAI_API_KEY")

#output files
output_df = "GPT_3.5/data/raw/gpt_3.5_additional_values_data_1.xlsx"

# File for history
history_file = open("GPT_3.5/logs/gpt_3.5_additional_values_history_1.txt", "a")
all_answers_file = open('GPT_3.5/data/raw/gpt_3.5_additional_values_data_1.pickle', 'ab')
