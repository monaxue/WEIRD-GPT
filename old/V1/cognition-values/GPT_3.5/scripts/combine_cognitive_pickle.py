import pickle
from prompts import cognitive_questions_2
df = cognitive_questions_2.df_i.copy()


data3 = []
with open('GPT_3.5/data/raw/all_answers_cognitive_3.5_new_3.pickle', 'rb') as file:
    while True:
        try:
...
data4 = []
with open('GPT_3.5/data/raw/all_answers_cognitive_3.5_new_4.pickle', 'rb') as file:
    while True:
        try:
            obj = pickle.load(file)
            # Do something with the object here
...
data5 = []
with open('GPT_3.5/data/raw/all_answers_cognitive_3.5_new_5.pickle', 'rb') as file:
    while True:
        try:
            obj = pickle.load(file)
            # Do something with the object here
...
data6 = []
with open('GPT_3.5/data/raw/all_answers_cognitive_3.5_new_6.pickle', 'rb') as file:
    while True:
        try:
            obj = pickle.load(file)
            # Do something with the object here
...
data7 = []
with open('GPT_3.5/data/raw/all_answers_cognitive_3.5_new_7.pickle', 'rb') as file:
    while True:
        try:
            obj = pickle.load(file)
            # Do something with the object here
...
data8 = []
with open('GPT_3.5/data/raw/all_answers_cognitive_3.5_new_8.pickle', 'rb') as file:
    while True:
        try:
            obj = pickle.load(file)
            # Do something with the object here
...
data9 = []
with open('GPT_3.5/data/raw/all_answers_cognitive_3.5_new_9.pickle', 'rb') as file:
    while True:
        try:
            obj = pickle.load(file)
            # Do something with the object here
...
with open('GPT_3.5/data/final/final_cognitive_3.5_new.pickle', 'wb') as file:
