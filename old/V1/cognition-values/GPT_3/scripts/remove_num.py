...
df = pd.read_excel('GPT_3/data/cleaned_data/processed/manual_cleaned_cognitive_qs.xlsx')
...
df_num_removed.to_excel('GPT_3/data/cleaned_data/manual_cleaned_cognitive_qs_num_removed.xlsx', index=False)