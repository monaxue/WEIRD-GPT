import pandas as pd
from prompts import values_questions
import ast

df = values_questions.df_i.copy()

input_file = open("GPT_3/logs/converted_values_history_1.txt", "r")
...
for line in input_file:
    ...
    df.to_excel('GPT_3/data/cleaned_data/cleaned_values_qs_1.xlsx', index=False)