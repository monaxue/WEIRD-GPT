...
output_df = "data/raw/gpt_3.5_happiness_5_data_2.xlsx"
history_file = open("logs/gpt_3.5_happiness_5_history_2.txt", "a")
all_answers_file = open('data/raw/gpt_3.5_happiness_5_data_2.pickle', 'ab')
...
df1 = pd.read_excel("data/raw/gpt_3.5_happiness_5_data_1.xlsx")
df2 = pd.read_excel("data/raw/gpt_3.5_happiness_5_data_2.xlsx")

df_concat = pd.concat([df1,df2]).astype(str)

df_final = df_concat.applymap(lambda x: x.strip(".0"))

df_final.to_excel('data/final/final_gpt_3.5_happiness_5_data.xlsx', index=False)
