...
data1 = []
with open('data/raw/gpt_3.5_wvs_data_1.pickle', 'rb') as file:
    while True:
        try:
...
data2 = []
with open('data/raw/gpt_3.5_wvs_data_2.pickle', 'rb') as file:
    while True:
        try:
            obj = pickle.load(file)
            # Do something with the object here
...
with open('data/final/final_gpt_3.5_wvs_data.pickle', 'wb') as file:
