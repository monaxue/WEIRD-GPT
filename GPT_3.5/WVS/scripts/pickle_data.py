import pickle
import questions.additional_values_questions as additional_values_questions
...
data = []
with open('final_gpt_3.5_wvs_data.pickle', 'rb') as file:
    while True:
        try:
...
filtered_list = [obj for obj in data if (obj.iteration == 163) & (obj.master_name == 'trust_5')]
